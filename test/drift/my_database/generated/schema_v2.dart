...
class BlocksData extends DataClass implements Insertable<BlocksData> {
  ...
  const BlocksData({
    ...
    required this.positionAmongstSiblings,
  ...
  BlocksCompanion toCompanion(bool nullToAbsent) {
    return BlocksCompanion(
      ...
      positionAmongstSiblings: Value(positionAmongstSiblings),
...
class BlocksCompanion extends UpdateCompanion<BlocksData> {
  ...
  BlocksCompanion.insert({
    ...
    required int positionAmongstSiblings,
